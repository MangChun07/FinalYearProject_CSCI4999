...
class HandNet(nn.Module):
    ...
    def forward(self, x):
        ...
        d_f8 = nn.functional.interpolate(d_f7+d_f4, scale_factor=float(2), mode='bilinear')
        d_f8 = self.conv8(d_f8)                # (1 * 128 * 128 * 128)
        d_f9 = nn.functional.interpolate(d_f8+d_f3, scale_factor=float(2), mode='bilinear')
        d_f9 = self.conv9(d_f9)                # (1 * 64 * 256 * 256)
        d_f10 = nn.functional.interpolate(d_f9+d_f2, scale_factor=float(2), mode='bilinear')
